...
using SettlementBookingSystem.Infrastructure.Bookings.Repositories;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddProblemDetails(options =>
            {
                ...
                //options.Map<BadRequestException>(ex => new BadRequestProblemDetails(ex));
                ...
                options.Map<AggregateException>(ex =>
                {
                    return ex.InnerException switch
                    {
                        ...
                        //BadRequestException badRequest => new BadRequestProblemDetails(badRequest),
